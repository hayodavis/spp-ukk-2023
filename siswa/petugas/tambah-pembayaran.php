...
<form method="post" action="?url=proses-tambah-pembayaran&nisn=<?= $nisn; ?>">
    ...
    <div class="form-group mb-2">
        ...
        <input type="date" name="tgl_bayar" class="form-contro" required>
    </div>
    <div class="form-group mb-2">
    ...
    <div class="form-group mb-2">
        <label for="jumlah_bayar">Jumlah Bayar (Jumlah yang harus dibayar adalah <b><?= number_format($kekurangan, 2, ',', '.') ?></b>)</label>
